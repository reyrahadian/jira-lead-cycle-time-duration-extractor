...
STAGE_NAME_GROUPINGS = {
    ...
    STAGE_NAME_IN_PROGRESS: [STAGE_NAME_IN_DEVELOPMENT, STAGE_NAME_IN_PROGRESS, STAGE_NAME_IN_ANALYSIS],
    STAGE_NAME_IN_CODE_REVIEW: [STAGE_NAME_IN_CODE_REVIEW],
    STAGE_NAME_IN_PR_TEST: [STAGE_NAME_READY_FOR_PR_TEST, STAGE_NAME_IN_PR_TEST],
    STAGE_NAME_IN_SIT_TEST: [STAGE_NAME_READY_FOR_SIT_TEST, STAGE_NAME_IN_SIT_TEST, STAGE_NAME_IN_SIT],
    STAGE_NAME_AWAITING_SIT_DEPLOYMENT: [STAGE_NAME_AWAITING_SIT_DEPLOYMENT],
    STAGE_NAME_AWAITING_UAT_DEPLOYMENT: [STAGE_NAME_AWAITING_UAT_DEPLOYMENT, STAGE_NAME_PENDING_DEPLOYMENT_TO_UAT],
    STAGE_NAME_IN_UAT_TEST: [STAGE_NAME_READY_FOR_UAT_TEST, STAGE_NAME_IN_UAT_TEST, STAGE_NAME_IN_UAT, STAGE_NAME_DEPLOYED_TO_UAT, STAGE_NAME_PO_REVIEW],
