...
COLUMN_NAME_CALCULATED_SPRINT = "CalculatedSprint"
COLUMN_NAME_NAME = "Name"
COLUMN_NAME_TYPE = "Type"
COLUMN_NAME_SQUAD = "Squad"
COLUMN_NAME_SQUAD2 = "Squad2"
...
COLUMN_NAME_STAGE_IN_SIT2_DAYS = "Stage In SIT days"
...
STAGE_NAME_BUILD = "Build"
STAGE_NAME_UNIT_TEST = "Unit Test"
...
STAGE_NAME_ASSIGN_TO_QA = "Assign to QA"
...
STAGE_NAME_READY_FOR_PROD_RELEASE = "Ready for Prod Release"
...
ALL_STAGE_NAMES = [
    ...
    STAGE_NAME_READY_FOR_PROD_RELEASE,
...
# stage names that represent in progress stages, grouped and represented by a common stage name
STAGE_NAME_GROUPINGS = {
    STAGE_NAME_ON_HOLD: [STAGE_NAME_ON_HOLD],
    ...
    STAGE_NAME_IN_SIT_TEST: [STAGE_NAME_READY_FOR_SIT_TEST, STAGE_NAME_IN_SIT_TEST, STAGE_NAME_IN_SIT, STAGE_NAME_IN_SIT2, STAGE_NAME_IN_TEST],
    ...
    STAGE_NAME_AWAITING_PROD_DEPLOYMENT: [STAGE_NAME_AWAITING_PROD_DEPLOYMENT, STAGE_NAME_PROD_PRE_CHECK_DEPLOYMENT, STAGE_NAME_READY_FOR_PROD_RELEASE, STAGE_NAME_PRE_PRODUCTION],
}

# stage names that represent the beginning stages
STAGE_NAME_BEGINNING_STAGES = [
    STAGE_NAME_BACKLOG,
    STAGE_NAME_DELIVERY_BACKLOG,
    STAGE_NAME_OPEN,
    STAGE_NAME_IDEAS_INTAKE,
...
STAGE_NAME_IGNORE = STAGE_NAME_BEGINNING_STAGES + STAGE_NAME_FINAL_STAGES
STAGE_NAME_IN_PROGRESS = [stage for stage in ALL_STAGE_NAMES if stage not in STAGE_NAME_IGNORE]

ALL_STAGE_COLUMNS_DURATIONS_IN_DAYS = [
    f"Stage {stage} days" for stage in ALL_STAGE_NAMES
]

ALL_STAGE_COLUMNS_IN_SPRINT_DURATION_IN_DAYS = [
    f"Stage {stage} days in sprint" for stage in ALL_STAGE_NAMES
]

THRESHOLD_STAGE_COLUMNS_DURATION_IN_DAYS = [
    f"Stage {stage} days" for stage in STAGE_NAME_IN_PROGRESS
]
